...
export const ERROR_CATALOG = {
  ...
  oracle_witness_not_qualified: { status: 422, message: "A qualifying Sportmonks confirmation binding is required.", retryable: false },
  oracle_witness_credential_unavailable: { status: 503, message: "The configured Sportmonks credential is unavailable.", retryable: true },
  ...
  oracle_witness_source_unavailable: { status: 503, message: "Sportmonks confirmation is temporarily unavailable.", retryable: true },
  ...
  liquidity_oracle_unhealthy: { status: 503, message: "Protocol liquidity is stopped until Sportmonks evidence health recovers.", retryable: true },
  ...
  market_intake_disabled: { status: 409, message: "New order intake is disabled for this legacy market.", retryable: false },
